...
class TestDimensionResolver:
    ...
    def test_dimension_expression_caching(self):
        ...
        expression3 = resolver.resolve_dimension_expression("squared_value", current_model="metrics")
    ...
    def test_resolve_dimension_reference(self):
        ...
        expression, models = resolver.resolve_dimension_reference("${ref(product_id)}", current_model="products")
