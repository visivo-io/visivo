...
class TestFlaskSourceEndpoints:
    ...
    def setup_method(self):
        ...
        with patch('visivo.server.flask_app.Serializer') as mock_serializer:
            ...
            mock_serializer_instance.dereference.return_value.model_dump_json.return_value = json.dumps({
                "name": "test_project",
    ...
    def test_test_connection_success(self):
        ...
        with patch('visivo.server.flask_app.test_source_connection') as mock_test:
    ...
    def test_endpoint_error_responses(self):
        ...
        endpoints_and_mocks = [
            ('/api/project/sources/test/test-connection', 'test_source_connection'),
