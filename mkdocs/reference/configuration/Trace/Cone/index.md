```
anchor: enumerated , one of ( "tip" | "tail" | "cm" | "center" )
...
hoverinfo: flaglist string. any combination of "x", "y", "z", "u", "v", "w", "norm",
  "text", "name" joined with a "+" or "all" or "none" or "skip".
hoverlabel:
...
showlegend: boolean
showscale: boolean
sizemode: enumerated , one of ( "scaled" | "absolute" )
