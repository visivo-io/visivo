...
def modify_mkdocs_yaml():
    ...
    if not os.path.isfile('mkdocs.yml'):
        raise FileNotFoundError('Script expects mkdocs.yml to be present in the working directory')
    ...
    with open('mkdocs.yml', 'w') as file:
        yaml.dump(updated_mkdocs_yaml_object, file, default_flow_style = False, sort_keys=False, Dumper=CustomDumper)
