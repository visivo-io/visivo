  ...
  return (
    <div style={{ padding: '20px', backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
      ...
      <div style={{ marginTop: '40px', padding: '20px', backgroundColor: 'white', borderRadius: '8px' }}>
        ...
        <ol>
          <li>Build the embed library: <code>yarn build:embed</code></li>
          <li>Import the component: <code>import {`{ Visivo }`} from './src/embed';</code></li>
        ...
        <ul>
          <li><strong>project</strong>: The name of your Visivo project</li>
          <li><strong>stage</strong>: The stage name (e.g., 'production', 'dev')</li>
          <li><strong>item</strong>: The name of the dashboard, chart, table, or markdown to embed</li>
        </ul>
        
        <h3>Optional Props</h3>
        <ul>
          <li><strong>host</strong>: Your Visivo API URL (defaults to https://api.visivo.io)</li>
          <li><strong>apiKey</strong>: Your API key for authentication (required for private projects)</li>
          <li><strong>style</strong>: CSS styles to apply to the container</li>
          <li><strong>className</strong>: CSS class name for the container</li>
          <li><strong>loading</strong>: Custom loading component</li>
          <li><strong>error</strong>: Custom error component</li>
          <li><strong>onLoad</strong>: Callback when data loads successfully</li>
          <li><strong>onError</strong>: Callback when an error occurs</li>
        </ul>
      </div>
    </div>
  );
