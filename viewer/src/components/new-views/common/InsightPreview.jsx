...
const InsightPreview = ({
  ...
  if (!shouldFetchData) {
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 text-center">
        <InfoOutlinedIcon className="text-gray-400 mb-2" sx={{ fontSize: 48 }} />
        <h3 className="text-lg font-medium text-gray-700 mb-2">Save to Preview Data</h3>
        <p className="text-sm text-gray-500 max-w-sm">
          Save the insight first to see a preview with actual data. You can still configure the visualization properties.
        </p>
      </div>
    );
  }
