const Toggle = (props) => {
    return (
        <label className="relative inline-flex items-center cursor-pointer" >
            <input type="checkbox" readOnly id={props.name} alt={props.alt} value={props.value} checked={!!props.value} name={props.name} className="sr-only peer" onClick={props.onClick} />
