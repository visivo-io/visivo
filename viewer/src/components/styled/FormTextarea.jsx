...
/**
 * FormTextarea - Styled textarea with floating label, error handling, and disabled state
 *
 * Features:
 ...
 *
 * Props:
 * - id: Textarea element id (required for label association)
 * - label: Label text
 ...
 * - helperText: Optional helper text below textarea
 * - rows: Number of visible rows (default: 3)
 * - className: Additional classes for the container
 * - ...rest: Passed to textarea element
 */
const FormTextarea = forwardRef(
  (
    { id, label, value, onChange, error, disabled, required, helperText, rows = 3, className = '', ...rest },
    ref
  ) => {
