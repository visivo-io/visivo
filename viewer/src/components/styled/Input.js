...
const Input = (props) => {
    ...
    return (
        <div className="relative">
            {/* <input ref={inputRef} type={props.type ? props.type : "text"} id={props.name} alt={props.alt} value={props.value} onChange={props.onChange} name={props.name} className="block px-2 pb-1 pt-2.5 w-full text-sm text-gray-900 bg-transparent rounded-md border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-primary peer" placeholder=" " /> */}
            <input type={props.type ? props.type : "text"} id={props.name} alt={props.alt} value={props.value} onChange={props.onChange} name={props.name} className="block px-2 pb-1 pt-2.5 w-full text-sm text-gray-900 bg-transparent rounded-md border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-primary peer" placeholder=" " />
