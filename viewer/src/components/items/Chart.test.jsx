...
// Capture the layout prop passed to Plot so we can assert on the computed
// layoutRef (colorway, legend defaults, margin defaults, autosize, etc.).
