...
const renderInDnd = async (ui) => {
  let view;
  await act(async () => {
    view = render(<DndContext>{ui}</DndContext>);
  });
  return view;
};
...
describe('ChartCRUDSection', () => {
  ...
  it('renders chart name in header', async () => {
    await renderInDnd(<ChartCRUDSection isExpanded={true} onToggleExpand={jest.fn()} />);
  ...
  it('does not render SchemaEditor when collapsed', async () => {
    await renderInDnd(<ChartCRUDSection isExpanded={false} onToggleExpand={jest.fn()} />);
  ...
  it('collapse/expand toggle works', async () => {
    ...
    await renderInDnd(<ChartCRUDSection isExpanded={true} onToggleExpand={onToggleExpand} />);
