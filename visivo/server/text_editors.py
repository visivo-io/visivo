...
def get_editor_configs():
    ...
    editors = [
        {
            ...
            "id": "vscode",
            "paths": {
                "windows": win_program_files_paths(r"Microsoft VS Code\bin\code.cmd") + [r"C:\Users\%USERNAME%\AppData\Local\Programs\Microsoft VS Code\bin\code.cmd"],
                "mac": [
                    "/usr/local/bin/code",
    ...
    if is_mac:
        editors.append({
            ...
            "paths": {
                "windows": [],
                "mac": ["/usr/local/bin/bbedit", "/Applications/BBEdit.app/Contents/Helpers/bbedit_tool"],
                "linux": []
            },
            "commands": {
                "windows": None,
