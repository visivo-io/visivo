...
class Cumulative1(TracePropsAttribute):
...
class HistogramError_x(TracePropsAttribute):
	...
	copy_ystyle: Optional[bool | IndexedStatementField]= Field(
		None,
		description=""" boolean<br> """
	)
	symmetric: Optional[bool | IndexedStatementField]= Field(
		None,
	...
	traceref: Optional[int | IndexedStatementField]= Field(
		None,
		description=""" integer greater than or equal to 0<br> """
	)
	tracerefminus: Optional[int | IndexedStatementField]= Field(
		None,
		description=""" integer greater than or equal to 0<br> """
	)
	...
	value: Optional[float | IndexedStatementField]= Field(
		None,
	...
	valueminus: Optional[float | IndexedStatementField]= Field(
		None,
...
class PatternFillpattern1(TracePropsAttribute):
	...
	fgopacity: Optional[float | IndexedStatementField]= Field(
		None,
	...
	solidity: Optional[IndexedStatementField | StatementField | float | List[float]]= Field(
		None,
...
class HistogramMarker(TracePropsAttribute):
	...
	opacity: Optional[IndexedStatementField | StatementField | float | List[float]]= Field(
		None,
...
class Xbins2(TracePropsAttribute):
	end: Optional[float | IndexedStatementField]= Field(
		None,
	...
	start: Optional[float | IndexedStatementField]= Field(
		None,
...
class Ybins2(TracePropsAttribute):
	end: Optional[float | IndexedStatementField]= Field(
		None,
...
class Histogram(TraceProps):
	...
	autobinx: Optional[bool | IndexedStatementField]= Field(
		None,
	...
	autobiny: Optional[bool | IndexedStatementField]= Field(
		None,
	...
	cumulative: Optional[Cumulative1]= Field(
		None,
		description=""" object containing one or more of the keys listed below.<br> """
	)
	...
	insidetextfont: Optional[TextfontLabelfontTickfontInsidetextfontRangefontOutsidetextfontFontGrouptitlefont1]= Field(
		None,
	...
	nbinsx: Optional[int | IndexedStatementField]= Field(
		None,
	...
	nbinsy: Optional[int | IndexedStatementField]= Field(
		None,
	...
	outsidetextfont: Optional[TextfontLabelfontTickfontInsidetextfontRangefontOutsidetextfontFontGrouptitlefont1]= Field(
		None,
