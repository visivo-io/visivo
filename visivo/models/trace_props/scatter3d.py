...
class Scatter3dError_x(TracePropsAttribute):
    ...
    copy_zstyle: Optional[bool | IndexedStatementField] = Field(
...
class Scatter3d(TraceProps):
    ...
    surfacecolor: Optional[str] = Field(
        None, description=""" color<br>Sets the surface fill color. """
    )
    ...
    type: Literal["scatter3d"] = Field(..., description=""" "scatter3d"<br> """)
