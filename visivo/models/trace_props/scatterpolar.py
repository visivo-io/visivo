...
class Scatterpolar(TraceProps):
    ...
    dr: Optional[float | IndexedStatementField] = Field(
        None, description=""" number<br>Sets the r coordinate step. """
    )
    dtheta: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    r0: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    r: Optional[StatementField | List] = Field(
        None, description=""" data array<br>Sets the radial coordinates """
    )
    ...
    theta0: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    theta: Optional[StatementField | List] = Field(
        None, description=""" data array<br>Sets the angular coordinates """
    )
    ...
    type: Literal["scatterpolar"] = Field(..., description=""" "scatterpolar"<br> """)
