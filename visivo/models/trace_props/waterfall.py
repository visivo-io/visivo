...
class WaterfallConnector(TracePropsAttribute):
    ...
    visible: Optional[bool | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None, description=""" boolean<br>Determines if connector lines are drawn.  """
    )


class Line24(TracePropsAttribute):
    color: Optional[str] = Field(
        None, description=""" color<br>Sets the line color of all decreasing values. """
    )
    width: Optional[float | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None,
...
class WaterfallDecreasingMarker(TracePropsAttribute):
    color: Optional[str] = Field(
        None, description=""" color<br>Sets the marker color of all decreasing values. """
    )
...
class Line27(TracePropsAttribute):
    color: Optional[str] = Field(
        None, description=""" color<br>Sets the line color of all increasing values. """
    )
    width: Optional[float | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None,
...
class WaterfallIncreasingMarker(TracePropsAttribute):
    color: Optional[str] = Field(
        None, description=""" color<br>Sets the marker color of all increasing values. """
    )
...
class Waterfall(TraceProps):
    ...
    dx: Optional[float | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None, description=""" number<br>Sets the x coordinate step. See `x0` for more info. """
    )
    dy: Optional[float | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None, description=""" number<br>Sets the y coordinate step. See `y0` for more info. """
    )
    ...
    type: Literal["waterfall"] = Field(..., description=""" "waterfall"<br> """)
