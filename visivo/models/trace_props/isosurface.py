...
class Contour1(TracePropsAttribute):
    color: Optional[str] = Field(
        None, description=""" color<br>Sets the color of the contour lines. """
    )
    show: Optional[bool | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None, description=""" boolean<br>Sets whether or not dynamic contours are shown on hover """
    )
...
class Isosurface(TraceProps):
    ...
    contour: Optional[Contour1] = Field(
        None, description=""" object containing one or more of the keys listed below.<br> """
    )
    ...
    isomax: Optional[float | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None, description=""" number<br>Sets the maximum boundary for iso-surface plot. """
    )
    isomin: Optional[float | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None, description=""" number<br>Sets the minimum boundary for iso-surface plot. """
    )
    ...
    type: Literal["isosurface"] = Field(..., description=""" "isosurface"<br> """)
    ...
    value: Optional[constr(pattern=STATEMENT_REGEX) | List] = Field(
        None, description=""" data array<br>Sets the 4th dimension (value) of the vertices. """
    )
    ...
    x: Optional[constr(pattern=STATEMENT_REGEX) | List] = Field(
        None, description=""" data array<br>Sets the X coordinates of the vertices on X axis. """
    )
    ...
    y: Optional[constr(pattern=STATEMENT_REGEX) | List] = Field(
        None, description=""" data array<br>Sets the Y coordinates of the vertices on Y axis. """
    )
    ...
    z: Optional[constr(pattern=STATEMENT_REGEX) | List] = Field(
        None, description=""" data array<br>Sets the Z coordinates of the vertices on Z axis. """
    )
