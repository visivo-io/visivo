...
class Line13(TracePropsAttribute):
	backoff: Optional[IndexedStatementField | StatementField | float | List[float]]= Field(
		None,
...
class ScatterMarker(TracePropsAttribute):
	...
	standoff: Optional[IndexedStatementField | StatementField | float | List[float]]= Field(
		None,
