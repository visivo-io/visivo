...
class PatternFillpattern1(TracePropsAttribute):
    ...
    solidity: Optional[IndexedStatementField | StatementField | float | List[float]] = (
        Field(
            None,
...
class Line13(TracePropsAttribute):
    backoff: Optional[IndexedStatementField | StatementField | float | List[float]] = (
        Field(
            None,
    ...
    simplify: Optional[bool | IndexedStatementField] = Field(
        None,
...
class ScatterMarker(TracePropsAttribute):
    ...
    maxdisplayed: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    opacity: Optional[IndexedStatementField | StatementField | float | List[float]] = (
        Field(
            None,
    ...
    sizemin: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    sizeref: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    standoff: Optional[IndexedStatementField | StatementField | float | List[float]] = (
        Field(
            None,
...
class Scatter(TraceProps):
    ...
    connectgaps: Optional[bool | IndexedStatementField] = Field(
        None,
    ...
    type: Literal["scatter"] = Field(..., description=""" "scatter"<br> """)
