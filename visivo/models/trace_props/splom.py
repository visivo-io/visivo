...
class Diagonal1(TracePropsAttribute):
...
class Axis1(TracePropsAttribute):
    matches: Optional[bool | IndexedStatementField] = Field(
        None,
...
class Splom(TraceProps):
    ...
    diagonal: Optional[Diagonal1] = Field(
        None,
        description=""" object containing one or more of the keys listed below.<br> """,
    )
    ...
    showlowerhalf: Optional[bool | IndexedStatementField] = Field(
        None,
        description=""" boolean<br>Determines whether or not subplots on the lower half from the diagonal are displayed. """,
    )
    showupperhalf: Optional[bool | IndexedStatementField] = Field(
        None,
    ...
    type: Literal["splom"] = Field(..., description=""" "splom"<br> """)
