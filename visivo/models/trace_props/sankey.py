...
class SankeyLink(TracePropsAttribute):
    ...
    label: Optional[StatementField | List] = Field(
...
class SankeyNode(TracePropsAttribute):
    ...
    groups: Optional[StatementField | List] = Field(
        None,
