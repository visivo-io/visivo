...
class Streamtube(TraceProps):
    ...
    hovertext: Optional[str] = Field(
        None, description=""" string<br>Same as `text`. """
    )
    ...
    maxdisplayed: Optional[int | IndexedStatementField] = Field(
        None,
    ...
    u: Optional[StatementField | List] = Field(
        None,
    ...
    v: Optional[StatementField | List] = Field(
        None,
    ...
    w: Optional[StatementField | List] = Field(
        None,
