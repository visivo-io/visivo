...
class Starts1(TracePropsAttribute):
...
class Streamtube(TraceProps):
    ...
    hovertext: Optional[str] = Field(None, description=""" string<br>Same as `text`. """)
    ...
    type: Literal["streamtube"] = Field(..., description=""" "streamtube"<br> """)
    u: Optional[constr(pattern=STATEMENT_REGEX) | List] = Field(
        None, description=""" data array<br>Sets the x components of the vector field. """
    )
    ...
    v: Optional[constr(pattern=STATEMENT_REGEX) | List] = Field(
        None, description=""" data array<br>Sets the y components of the vector field. """
    )
    ...
    w: Optional[constr(pattern=STATEMENT_REGEX) | List] = Field(
        None, description=""" data array<br>Sets the z components of the vector field. """
    )
    ...
    x: Optional[constr(pattern=STATEMENT_REGEX) | List] = Field(
        None, description=""" data array<br>Sets the x coordinates of the vector field. """
    )
    ...
    y: Optional[constr(pattern=STATEMENT_REGEX) | List] = Field(
        None, description=""" data array<br>Sets the y coordinates of the vector field. """
    )
    ...
    z: Optional[constr(pattern=STATEMENT_REGEX) | List] = Field(
        None, description=""" data array<br>Sets the z coordinates of the vector field. """
    )
