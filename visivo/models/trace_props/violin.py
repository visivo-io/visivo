...
class Line25(TracePropsAttribute):
    color: Optional[str] = Field(
        None, description=""" color<br>Sets the inner box plot bounding line color. """
    )
...
class ViolinBox(TracePropsAttribute):
    fillcolor: Optional[str] = Field(
        None, description=""" color<br>Sets the inner box plot fill color. """
    )
...
class Line22(TracePropsAttribute):
    color: Optional[str] = Field(
        None, description=""" color<br>Sets the color of line bounding the violin(s). """
    )
    width: Optional[float | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None,
...
class ViolinMarker(TracePropsAttribute):
    angle: Optional[float | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None, description=""" angle<br>Sets the marker angle in respect to `angleref`. """
    )
    color: Optional[str] = Field(
        None,
    ...
    opacity: Optional[float | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None, description=""" number between or equal to 0 and 1<br>Sets the marker opacity. """
    )
    outliercolor: Optional[str] = Field(
        None, description=""" color<br>Sets the color of the outlier sample points. """
    )
    size: Optional[float | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None, description=""" number greater than or equal to 0<br>Sets the marker size (in px). """
    )
...
class Meanline1(TracePropsAttribute):
    color: Optional[str] = Field(None, description=""" color<br>Sets the mean line color. """)
    visible: Optional[bool | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None,
    ...
    width: Optional[float | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None, description=""" number greater than or equal to 0<br>Sets the mean line width. """
    )
...
class Violin(TraceProps):
    ...
    type: Literal["violin"] = Field(..., description=""" "violin"<br> """)
