...
class ContourcarpetContours(TracePropsAttribute):
    ...
    showlabels: Optional[bool | IndexedStatementField] = Field(
        None,
        description=""" boolean<br>Determines whether to label the contour lines with their values. """,
    )
    showlines: Optional[bool | IndexedStatementField] = Field(
        None,
...
class Line7(TracePropsAttribute):
...
class Contourcarpet(TraceProps):
    ...
    autocontour: Optional[bool | IndexedStatementField] = Field(
        None,
    ...
    ncontours: Optional[int | IndexedStatementField] = Field(
        None,
    ...
    transpose: Optional[bool | IndexedStatementField] = Field(
        None, description=""" boolean<br>Transposes the z data. """
    )
    type: Literal["contourcarpet"] = Field(..., description=""" "contourcarpet"<br> """)
    ...
    zmax: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    zmid: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    zmin: Optional[float | IndexedStatementField] = Field(
        None,
