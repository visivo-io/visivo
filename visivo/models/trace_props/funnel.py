...
class FunnelConnector(TracePropsAttribute):
    fillcolor: Optional[str] = Field(None, description=""" color<br>Sets the fill color. """)
    ...
    visible: Optional[bool | constr(pattern=INDEXED_STATEMENT_REGEX)] = Field(
        None, description=""" boolean<br>Determines if connector regions and lines are drawn. """
    )
...
class Funnel(TraceProps):
    ...
    type: Literal["funnel"] = Field(..., description=""" "funnel"<br> """)
