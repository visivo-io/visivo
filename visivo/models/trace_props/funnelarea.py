...
class Funnelarea(TraceProps):
    aspectratio: Optional[float | IndexedStatementField] = Field(
        None,
        description=""" number greater than or equal to 0<br>Sets the ratio between height and width """,
    )
    baseratio: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    type: Literal["funnelarea"] = Field(..., description=""" "funnelarea"<br> """)
