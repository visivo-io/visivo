...
class Dimensions2(TracePropsAttribute):
    constraintrange: Optional[StatementField | List] = Field(
        None,
    ...
    multiselect: Optional[bool | IndexedStatementField] = Field(
        None,
...
class Parcoords(TraceProps):
    ...
    labelangle: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    type: Literal["parcoords"] = Field(..., description=""" "parcoords"<br> """)
