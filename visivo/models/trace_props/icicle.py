...
class Leaf1(TracePropsAttribute):
...
class Root1(TracePropsAttribute):
...
class Tiling1(TracePropsAttribute):
...
class Icicle(TraceProps):
    ...
    tiling: Optional[Tiling1] = Field(
        None, description=""" object containing one or more of the keys listed below.<br> """
    )
    type: Literal["icicle"] = Field(..., description=""" "icicle"<br> """)
