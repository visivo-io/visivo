...
class CarpetAaxis(TracePropsAttribute):
    arraydtick: Optional[int | IndexedStatementField] = Field(
        None,
        description=""" integer greater than or equal to 1<br>The stride between grid lines along the axis """,
    )
    arraytick0: Optional[int | IndexedStatementField] = Field(
        None,
    ...
    cheatertype: Optional[str] = Field(
        None, description=""" enumerated , one of ( "index" | "value" )<br> """
    )
    ...
    endline: Optional[bool | IndexedStatementField] = Field(
        None,
    ...
    endlinecolor: Optional[str] = Field(
        None, description=""" color<br>Sets the line color of the end line. """
    )
    endlinewidth: Optional[float | IndexedStatementField] = Field(
        None, description=""" number<br>Sets the width (in px) of the end line. """
    )
    ...
    labelpadding: Optional[int | IndexedStatementField] = Field(
        None, description=""" integer<br>Extra padding between label and the axis """
    )
    labelprefix: Optional[str] = Field(
        None, description=""" string<br>Sets a axis label prefix. """
    )
    labelsuffix: Optional[str] = Field(
        None, description=""" string<br>Sets a axis label suffix. """
    )
    ...
    minorgridcount: Optional[int | IndexedStatementField] = Field(
        None,
    ...
    minorgridwidth: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    smoothing: Optional[float | IndexedStatementField] = Field(
        None, description=""" number between or equal to 0 and 1.3<br> """
    )
    startline: Optional[bool | IndexedStatementField] = Field(
        None,
    ...
    startlinecolor: Optional[str] = Field(
        None, description=""" color<br>Sets the line color of the start line. """
    )
    startlinewidth: Optional[float | IndexedStatementField] = Field(
        None, description=""" number<br>Sets the width (in px) of the start line. """
    )
    ...
    tickmode: Optional[str] = Field(
        None, description=""" enumerated , one of ( "linear" | "array" )<br> """
    )
...
class Carpet(TraceProps):
    a0: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    b0: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    cheaterslope: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    da: Optional[float | IndexedStatementField] = Field(
        None,
        description=""" number<br>Sets the a coordinate step. See `a0` for more info. """,
    )
    db: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    type: Literal["carpet"] = Field(..., description=""" "carpet"<br> """)
