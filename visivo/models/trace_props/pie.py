...
class Line19(TracePropsAttribute):
    color: Optional[str | List[str]] = Field(
        None,
...
class Pie(TraceProps):
    automargin: Optional[bool | IndexedStatementField] = Field(
        None,
    ...
    dlabel: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    label0: Optional[float | IndexedStatementField] = Field(
        None,
    ...
    pull: Optional[IndexedStatementField | StatementField | float | List[float]] = (
        Field(
            None,
    ...
    type: Literal["pie"] = Field(..., description=""" "pie"<br> """)
