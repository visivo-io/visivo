...
class DimensionResolver:
    ...
    def resolve_dimension_expression(self, dimension_name: str, current_model: Optional[str] = None) -> str:
        """
    ...
    def resolve_dimension_reference(self, reference: str, current_model: Optional[str] = None) -> tuple:
        """
